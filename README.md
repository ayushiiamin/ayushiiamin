...
[![My Skills](https://skillicons.dev/icons?i=py,html,css,js,java,ts,r,c,cpp,linux,pytorch,tensorflow,mysql,mongodb,postgres,sqlite,react,nodejs,jquery,bootstrap,express,sklearn,opencv,d3,bash,docker,postman,git,github,gitlab,powershell)](https://www.python.org/)
